...
class explore_your_new_self extends StatefulWidget {
  const explore_your_new_self({super.key});

  @override
  State<explore_your_new_self> createState() => _explore_your_new_selfState();
}

class _explore_your_new_selfState extends State<explore_your_new_self> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Explore your new self',
                      style:
                          TextStyle(fontSize: 22, fontWeight: FontWeight.w900)),
                  Text('Discover your inner peace',
                      style:
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Home cooking',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text('Eat healthy while saving money',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Get out of your shell and fill your mind with\n new ideas",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
