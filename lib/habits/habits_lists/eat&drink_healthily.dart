...
class eatdrink_healthily extends StatefulWidget {
  const eatdrink_healthily({super.key});

  @override
  State<eatdrink_healthily> createState() => _eatdrink_healthilyState();
}

class _eatdrink_healthilyState extends State<eatdrink_healthily> {
  @override
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Floss after eating',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text('Look presentable and smaile confidently',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Take vitamins',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text("Supplement with some 'magic bullets'",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text('The right mix of foods for optimal nutrition',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
