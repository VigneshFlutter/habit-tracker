...
class ease_stress extends StatefulWidget {
  const ease_stress({super.key});

  @override
  State<ease_stress> createState() => _ease_stressState();
}

class _ease_stressState extends State<ease_stress> {
  @override
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('Your efforts deserve a break',
                      style:
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Allow a moment to cry',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text('No hesitation for the release',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Pick a smell that eases you',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text("Seek fancy scents for stress relief",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text("Manage anxiety and 'over thinking'",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
