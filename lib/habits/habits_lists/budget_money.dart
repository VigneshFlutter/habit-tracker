...
class budget_money extends StatefulWidget {
  const budget_money({super.key});

  @override
  State<budget_money> createState() => _budget_moneyState();
}

class _budget_moneyState extends State<budget_money> {
  @override
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text('Disctinguish your needs and wants',
                                          style: TextStyle(
                                            fontSize: 14,
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text("Create shopping lists",
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text('Planning before spending',
                                          style: TextStyle(
                                            fontSize: 14,
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text('Check membership subscriptions',
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text("Click 'unsubscribe' when it feel unnecessary",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      Padding(
                                        padding: const EdgeInsets.only(bottom: 3),
                                        child: Text("Budget in 'fun money' ",
                                            style: TextStyle(
                                                fontSize: 18,
                                                fontWeight: FontWeight.w500,color: habit_text_color)),
                                      ),
                                      Text('Give yourself a budget line for fun',
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
                                ...
                                children: [
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Text("A financial 'backstop for life's uncertainties'",
                                          style: TextStyle(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w300,color: habit_text_color
                                          )),
